...
The clock, date and environmental screens below are generated by
`wokwi-icons.test.yaml` from the same `nano_328p_wokwi` firmware loaded by
`wokwi.toml`.

| Time | Calendar |
|---|---|
| <img src="./wokwi-clock.png" alt="Wokwi time screen" width="480"> | <img src="./wokwi-date.png" alt="Wokwi calendar screen" width="480"> |
