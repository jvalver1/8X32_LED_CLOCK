...
static const uint32_t PROGMEM ENVIRONMENTAL_ICONS[3][8][8] = {
    {
        ...
        {0x000000, 0xFFFFFF, 0xDDE8F5, 0x9FB3C8, 0x000000, 0, 0, 0},
        {0x000000, 0xC9D8E8, 0x000000, 0x6F849B, 0x000000, 0, 0, 0},
        {0x000000, 0xC9D8E8, 0xFFB24A, 0x6F849B, 0x000000, 0, 0, 0},
        {0x000000, 0xDDE8F5, 0xFF7A24, 0x6F849B, 0x000000, 0, 0, 0},
        {0x000000, 0xDDE8F5, 0xFF3B1F, 0x6F849B, 0x000000, 0, 0, 0},
        {0xFFFFFF, 0xFF6A22, 0xE92B16, 0x9E140F, 0x6F849B, 0, 0, 0},
        {0xC9D8E8, 0xFF8C32, 0xC91512, 0xFF461F, 0xC9D8E8, 0, 0, 0},
        {0x000000, 0xC9D8E8, 0xDDE8F5, 0x6F849B, 0x000000, 0, 0, 0}
    },
    {
        ...
        {0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0, 0, 0}*/
        {0x000000, 0x000000, 0xEAF4FF, 0x000000, 0x000000, 0, 0, 0},
        {0x000000, 0xFFFFFF, 0xBFD7FF, 0x6FA8FF, 0x000000, 0, 0, 0},
        {0xFFFFFF, 0xEAF4FF, 0xBFD7FF, 0x6FA8FF, 0x2F6BFF, 0, 0, 0},
        {0xEAF4FF, 0xBFD7FF, 0xBFD7FF, 0x2F6BFF, 0x2F6BFF, 0, 0, 0},
        {0xEAF4FF, 0x6FA8FF, 0x6FA8FF, 0x2F6BFF, 0x163B8F, 0, 0, 0},
        {0x000000, 0x2F6BFF, 0x2F6BFF, 0x163B8F, 0x000000, 0, 0, 0},
        {0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0, 0, 0},
        {0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0, 0, 0}
    },
    {
        ...
        {0x000000, 0xFFA552, 0xFF8A3D, 0xE53935, 0xC62828, 0, 0, 0},
        {0xFFC06A, 0xFF9A45, 0xF4511E, 0xC62828, 0x006DCE, 0, 0, 0},
        {0xFF8A3D, 0xF4511E, 0xC62828, 0x006BCC, 0x007EE5, 0, 0, 0},
        {0xE53935, 0xB71C1C, 0x006ECD, 0x0088EC, 0x68E5FC, 0, 0, 0},
        {0xC62828, 0x006DCE, 0x0089ED, 0x63E3FC, 0x7BEBFD, 0, 0, 0},
        {0x006ED0, 0x0081E7, 0x59E1FB, 0x73EAFD, 0x000000, 0, 0, 0},
        {0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0, 0, 0},
        {0x000000, 0x000000, 0x000000, 0x000000, 0x000000, 0, 0, 0}
    }
};

// Start with palette colour 8, RGB #00FFFF.
uint8_t DisplayManager::_paletteIndex = 8;
CRGB DisplayManager::_colorFrom = CRGB(0x00, 0xFF, 0xFF);
